  ...
  return (
    <div>
      <div className="w-10/12 mx-auto ">
        <div className="flex justify-between  border-b border-gray-300 mb-12">
          <div className="text-3xl font-semiboldx2 pb-4 mt-12">
            New Arrivals
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          <NavLink
            to="/products/1"
            className=" group border border-gray-300 py-8 px-4 space-y-1 hover:border-orange-300 cursor-pointer hover:shadow-md duration-300"
          >
          ...
          <NavLink to="/products/2" className=" group border border-gray-300 py-8 px-4 space-y-1 hover:border-orange-300 cursor-pointer hover:shadow-md duration-300">
            <div className="flex justify-end">
              <Heart className="opacity-0 group-hover:opacity-100 text-orange-500" />
            </div>
